...
public class ContentServiceAndRepoTest implements TestInterface {
    @Autowired
    ...
    public Content storeItem(String writer, String content, Document document) throws  Exception {
        return repo.save(Content.builder()
                .writer(writer)
                .content(content)
                .document(document)
            .build()
    ...
    public Content storeItem(Content content) throws Exception {
