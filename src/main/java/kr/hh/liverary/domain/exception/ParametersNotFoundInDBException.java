...
public class ParametersNotFoundInDBException extends CustomException{
    private static final long serialVersionUID = -85919360755508308L;

    public ParametersNotFoundInDBException() {
